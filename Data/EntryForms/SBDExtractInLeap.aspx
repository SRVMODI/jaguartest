...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fnDownloadCSVExtractReport(flg) {
            ...
            $("#dvloader").show();
            PageMethods.fnDownloadCSVExtractReport(LoginID, RoleID, UserID, ProdValues, LocValues, ChannelValues, ProcessGroup, ArrUser, Qtr, Yr, Version, fnDownloadCSVExtractReport_pass, fnfailed, flg);
        }
    ...
    <div class="row no-gutters" style="margin-top: -10px;">
        <div class="fsw col-12" id="Filter">
            <div class="fsw_inner">
                ...
                <div class="fsw_inputBox" id="divTypeSearchFilterBlock" style="width: 35%;">
                    <div class="row">
                        <div class="col-6">
