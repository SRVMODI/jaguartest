...
public partial class SBDExtractInLeap : System.Web.UI.Page
{
    ...
    [System.Web.Services.WebMethod()]
    public static string fnDownloadCSVExtractReport(string LoginID, string RoleID, string UserID, object objProd, object objLoc, object objChannel, string ProcessGroup, object objUser, string QtrNo, string QtrYear, string strVersion)
    {
        try
        {
            // ----------- MS & P
