...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fnDownload() {
            ...
            $("#dvloader").show();
            PageMethods.GetDownloadReport(LoginID, ProdValues, LocValues, ChannelValues, fromdate, todate, UserID, StageValues, RoleID, flgPage, flgInstance, MSMPValues, GetDownloadReport_pass, GetDownloadReport_failed);
        }
        ...
        //    var strStage = "";
        //    for (var i = 0; i < $("#ddlStage option:selected").length; i++) {
        //        strStage += $("#ddlStage option:selected").eq(i).val() + "^";
        //    }
        //    $("#ConatntMatter_hdnStage").val(strStage);
