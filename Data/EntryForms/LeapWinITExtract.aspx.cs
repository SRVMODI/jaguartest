...
public partial class Data_EntryForms_LeapWinITExtract : System.Web.UI.Page
{
    ...
    [System.Web.Services.WebMethod()]
    public static string GetDownloadReport(string login, object objProd, object objLoc, object objChannel, string fromdate, string todate, string user, object objStage, string role, string flgPage, string flgInstance, object objMSMP)
    {
