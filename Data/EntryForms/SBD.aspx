    ...
    <script type="text/javascript">
        function fnAddNew() {
            if ($("#ConatntMatter_hdnIsNewAdditionAllowed").val() == "0") {
                ...
                str += "<td iden='SBD'><div style='position: relative; width: 202px; min-width: 202px; box-sizing: border-box;'><div iden='content' style='font-size:0.6rem; width: 100%; padding-right: 30px;'></div><div style='position: absolute; right:5px; top:0px;'><img src='../../Images/favBucket.png' title='Favourite Bucket' iden='ProductHier' buckettype='6' BucketId='0' BrandId='' onclick='fnShowBaseSBFBucketPopup(this);'/></div></div></td>";        //SBF
        ...
        function fnBaseProxySBFBucketPopup(ctrl, strBrand) {
            ...
            $("#divCopyBucketPopup").dialog({
                ...
                open: function () {
                    ...
                    PageMethods.GetBaseSBFBucket(LoginID, RoleID, UserID, $("#ConatntMatter_hdnBucketType").val(), Qtr, Yr, strBrand, $(ctrl).closest("tr").attr("sbd"), GetBucketbasedonType_pass, GetBucketbasedonType_failed, $(ctrl).attr("BucketId"));
                },
                buttons: [{
                    text: 'Select',
                    class: 'btn-primary',
